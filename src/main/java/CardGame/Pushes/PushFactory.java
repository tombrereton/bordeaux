...
public class PushFactory {
    ...
    public PushProtocol createPush(int type, ServerThread cardGameServerThread) {
    ...
    private GameLobby getGame(ServerThread cardGameServerThread) {
